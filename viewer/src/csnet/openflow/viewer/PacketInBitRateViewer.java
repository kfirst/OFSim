...
public class PacketInBitRateViewer extends BaseViewer {

    private static final String NAME = "Packet-in Bit Rate";
    private int interval;
    private double multiple;
    private TimeSeriesCollection collection;

    public PacketInBitRateViewer(Map<String, DataLoader> loaders, int interval, boolean display) {
    ...
    protected void loadData(String name, DataLoader loader) {
        ...
        while (current + interval < end) {
            ...
            double count = loader.getTotalHeaderSizeOfPacketIn(current, current + interval) * multiple;
