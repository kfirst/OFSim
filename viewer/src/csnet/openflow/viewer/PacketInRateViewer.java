...
public class PacketInRateViewer extends BaseViewer {

    private static final String NAME = "Packet-in Rate";
    private int interval;
    private double multiple;
    private TimeSeriesCollection collection;

    public PacketInRateViewer(Map<String, DataLoader> loader, int interval, boolean display) {
    ...
    protected void loadData(String name, DataLoader loader) {
        ...
        while (current + interval < end) {
            ...
            double count = loader.getTotalNumOfPacketIn(current, current + interval) * multiple;
